...
if %ERRORLEVEL% EQU 0 (
    ...
    if exist "%TARGET_DIR%\ConsoleDemo.exe" (
        echo Executable is at %TARGET_DIR%\ConsoleDemo.exe
    ) else (
        echo Warning: Executable not found at expected location: %TARGET_DIR%\ConsoleDemo.exe
