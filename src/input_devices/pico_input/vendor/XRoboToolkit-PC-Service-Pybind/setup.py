...
import subprocess
import sys
# wuji-hand-teleop patch (2026-06-02): distutils was removed in Python 3.12+,
# so the legacy `from distutils.version import LooseVersion` import broke the
# Windows CMake-version guard on modern Pythons. packaging.version.Version
# preserves the same semver comparison semantics and is part of every
# setuptools install.
